...
# # print(data.columns)]
data["Caff"] = pd.Series(data["Caff"], dtype=pd.StringDtype())
#
...
data["Caff"].replace(to_replace='CL0', value='0', inplace=True, regex=True)
data["Caff"].replace(to_replace='CL1', value='0', inplace=True, regex=True)
data["Caff"].replace(to_replace='CL2', value='1', inplace=True, regex=True)
data["Caff"].replace(to_replace='CL3', value='1', inplace=True, regex=True)
data["Caff"].replace(to_replace='CL4', value='1', inplace=True, regex=True)
data["Caff"].replace(to_replace='CL5', value='1', inplace=True, regex=True)
data["Caff"].replace(to_replace='CL6', value='1', inplace=True, regex=True)
