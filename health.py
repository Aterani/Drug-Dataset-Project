...
for i in range(len(data1)):
    if data1['sex'][i] == 1 and data3['DaysInHospital_Y2'][i] == 0:
        femaleNonUser+=1
    elif data1['sex'][i] == 1 and data3['DaysInHospital_Y2'][i] == 1:
        femaleUser+=1
    elif data1['sex'][i] == 0 and data3['DaysInHospital_Y2'][i] == 0:
        maleNonUser+=1
    else:
        maleUser+=1
print(femaleUser)
