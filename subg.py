...
for i in range(len(data_1)):
    if data_1['Gender'][i] == 1 and data_1['Coke'][i] == 0 and femaleNonDrug < 672 - 270:
        data_1.drop(i, inplace=True)
        femaleNonDrug += 1
    elif data_1['Gender'][i] == 0 and data_1['Coke'][i] == 1 and maleDrug < 417 - 270:
        data_1.drop(i, inplace=True)
        maleDrug += 1
    elif data_1['Gender'][i] == 0 and data_1['Coke'][i] == 0 and maleNonDrug < 526 - 270:
        data_1.drop(i, inplace=True)
        maleNonDrug += 1
...
#print(str(len(data_1)) + " " + str(len(data_2)))
#print(data)
...
#seed_everything(0)
net = FullyConnectedNet(input_size=12, hidden_size=8, num_classes=1)
