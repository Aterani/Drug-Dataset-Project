...
# # print(data.columns)]
data["Ecstasy"] = pd.Series(data["Ecstasy"], dtype=pd.StringDtype())
#
...
data["Ecstasy"].replace(to_replace='CL0', value='0', inplace=True, regex=True)
data["Ecstasy"].replace(to_replace='CL1', value='0', inplace=True, regex=True)
data["Ecstasy"].replace(to_replace='CL2', value='1', inplace=True, regex=True)
data["Ecstasy"].replace(to_replace='CL3', value='1', inplace=True, regex=True)
data["Ecstasy"].replace(to_replace='CL4', value='1', inplace=True, regex=True)
data["Ecstasy"].replace(to_replace='CL5', value='1', inplace=True, regex=True)
data["Ecstasy"].replace(to_replace='CL6', value='1', inplace=True, regex=True)
